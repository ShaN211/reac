...
Feature: Equipment inspection PreTrip scenarios 
	This feature verifies all combinations of equipment inspection pre trip functionality
	
@RegressionTest 
Scenario: 01 Create a IE Event  -- Pre-Trip -- All good 
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | Pre-Trip            |
...
Scenario: 02 Create a IE Event  -- Pre-Trip -- All good -- New Event yes 
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | Pre-Trip            |
...
@RegressionTest
Scenario: 03 Create a IE Event  -- Pre-Trip -- defect -- Not safe to drive 
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | Pre-Trip            |
	...
	@RegressionTest 
Scenario: 04 Create a IE Event  -- Pre-Trip -- defect -- safe to drive
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | Pre-Trip            |
	...
	@RegressionTest
Scenario: 05 Create a IE Event  -- Pre-Trip -- defect -- Not safe to drive -- Create service event
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | Pre-Trip            |
