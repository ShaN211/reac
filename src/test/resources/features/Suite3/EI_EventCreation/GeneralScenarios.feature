Feature: Equipment inspection general scenarios 
	This feature verifies all combinations of equipment inspection general functionality
	
@RegressionTest 
Scenario: 01 Create a IE Event  -- General -- All good 
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | General             |
...
Scenario: 02 Create a IE Event  -- General -- All good -- New Event yes 
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | General             |
...
@RegressionTest
Scenario: 03 Create a IE Event  -- General -- defect -- Not safe to drive 
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | General             |
	...
	@RegressionTest 
Scenario: 04 Create a IE Event  -- General -- defect -- safe to drive
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | General             |
	...
	@RegressionTest
Scenario: 05 Create a IE Event  -- General -- defect -- Not safe to drive -- Create service event
	Given Create a EI event-- TD 
		| EquipmentType | EquipmentProvider | EquipmentInspection |
		| Chassis       | AutoTruck         | General             |
